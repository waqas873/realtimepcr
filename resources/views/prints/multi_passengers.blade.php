...
<head>
    ...
    <script>
        var printNumVal = 0;
        document.getElementById("printNum").innerHTML = printNumVal + 1;
        //CheckBOX function
...
<body>
    ...
    ?>
            <div class="container" style="padding: 20px" ; id="print_section">
                <div class="row">
                    <div class="col-sm-6"><b><?php echo "Rep-{$id}"; ?></b></div>
                    <div class="col-sm-6">
                        <div class="float-right">Report #<b>
                                <script>
                                    var printNumVal = printNumVal + 1;
                                    document.write(printNumVal);
                                </script>
                            </b>
                        </div>
                    </div>
