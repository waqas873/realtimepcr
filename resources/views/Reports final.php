...
<body>
    ...
    <div class="container" style="padding: 20px" ; id="print_section">
        ...
        <!--Test Reports Type-1 Component -->
        <div id="rep-type1">
            <div class="row component">
                <div class="col-sm-12">
                    <!-- <h3 class="TestDepartment">Department of Molecular Virology</h3>
                    <div class="chainReaction">Qualitative Polymerase Chain Reaction</div> -->
                    <h3 class="TestDepartment">
                        Department of
                        <?php echo (!empty($result->patient_tests[0]->test->category->name))?$result->patient_tests[0]->test->category->name:'Department of Molecular Virology'; ?>
                    </h3>
                    <div class="chainReaction">
                        <?php echo (!empty($result->patient_tests[0]->test->test_category->name))?$result->patient_tests[0]->test->test_category->name:'Qualitative Polymerase Chain Reaction'; ?>
                    </div>
                    <br>
                    <div class="row">
                        <!-- Test name -->
                        ...
                        <div class="col-sm-10">
                            <h6>
                                <?php echo (!empty($result->patient_tests[0]->test->name))?$result->patient_tests[0]->test->name:'---'; ?>
                            </h6>
                        </div>
                        <!-- Specimen -->
                        ...
                        <div class="col-sm-10">
                            <h6>
                                ...
                                <?php echo (!empty($result->patient_tests[0]->test->sample->name))?$result->patient_tests[0]->test->sample->name:'---'; ?>
                            </h6>
                        </div>
                        <!-- Test Result -->
                        <div class="col-sm-2">Test Result</div>
                        <div class="col-sm-10">
                            <h4 style="text-align: left;font-size: 22px; font-weight:700">
                                <?php  
                            $test_result = '<span style="color:#FF9800;">Awaiting Result</span>';
                            if($result->patient_tests[0]->status==1){
                                $test_result = '<span style="color:#DC4D41;">Positive</span>';
                            }
                            if($result->patient_tests[0]->status==2){
                                $test_result = '<span style="color:#7AB744;">Negative</span>';
                            }
                            echo $test_result; ?>
                            </h4>
                        </div>
            ...
            <div class="TestCmnts-cmp" id="TestCmnts-cmp">
                ...
                <p class="TestCmnts">
                    ...
                    <b>Methodology:</b>
                    Corona Virus RNA was extracted using auto extraction system (Life River). Amplified with 3 genes
                    amplification (life river), WHO recommended kits. For sample and batch validation, internal,
                    negative and positive controls were simultaneously amplified.
                    <br>
            ...
            <div class="row component">
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">"Patient value will be fetched Here" <span class="jfi">Dynamic</span></div>
            ...
            <div class="row component">
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">"Selected Genotype Result will be displayed here" <span class="jfi">Dynamic</span></div>
            ...
            <div class="row component">
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10"><b> Proteus Spp <span class="jfi">Dynamic</span></b></div>

                        <!-- Duration -->
                        <div class="col-sm-2">Duration</div>
                        <div class="col-sm-10"><b>24Hrs Aerobic Incubation at 37°C <span class="jfi">Dynamic</span> </b></div>
                            ...
                            <div class="component">
                                <div class="table-responsive">
                                    <table class="table mb-0 reports-table">
                                        ...
                                        <tr>
                                            <td><span class="jfi">Get from DB Dynamic</span></th>
                                            <td><span class="jfi">Get from DB Dynamic</span></th>
                                            <td><span class="jfi">Dynamic Entery by LabUser</span></th>
                                        </tr>
                                        <tr>
                                            <td>Medicine</th>
                                            <td>Label</th>
                        ...
                        <!-- Sensitivity Report -->
                        <div class="col-sm-2"><b>Keys</b></div>
                        <div class="col-sm-2">(S) Sensitive</div>
                        <div class="col-sm-3">(PS) Partial Sensitive</div>
                        <div class="col-sm-2">(R) Resistant</div>
                        <div class="col-sm-3">(NT) Not Tested</div>
