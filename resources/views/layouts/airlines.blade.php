...
<title>Airline | Realrtime PCR</title>
...
<li>
<a href="{{url('airlines/reports')}}" class="waves-effect">
<img src="{{asset('assets/icons/sidebar-icons/icon4.svg')}}" class="sidebar_icons">
...
<span class="d-none d-md-inline-block ml-1">Airline<i class="mdi mdi-chevron-down"></i> </span>
</a>
