    ...
    <div class="col-sm-12">
      <div class="page-title-box">
        <div class="row align-items-center">
          <div class="col-md-8">
            <h4 class="page-title m-0">Transactions & Transfers</h4>
          </div>
          <!-- end col -->
        </div>
        <!-- end row -->
                  ...
                  <td>
                    ...
                    if ($value->is_accepted == 1) {
                      if ($value->from_user == $login_user_id) {
                        $action = '<a href="' . url('admin/cancel-transfer/' . $value->id) . '" class="btn btn-danger transfer_action">Cancel Transfer</a>';
                      } else {
                        $action = '<a href="' . url('admin/accept-transfer/' . $value->id) . '" class="btn btn-success transfer_action">Accept</a> | <a href="' . url('admin/reject-transfer/' . $value->id) . '" class="btn btn-danger transfer_action">Reject</a>';
                      }
...
<script src="{{asset('assets/developer/admin/amounts.js')}}"></script>
