      ...
      <div class="modal-body">
            <form action="" id="add-lab-user-form" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control inputs_with_bottom_border select2" id="lab_id" name="lab_id">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control inputs_with_bottom_border select2" id="role" name="role">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control inputs_with_bottom_border" id="cnic" name="cnic" placeholder="Enter CNIC">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control inputs_with_bottom_border" id="username" name="username" placeholder="Enter username">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control inputs_with_bottom_border" id="pay" name="pay" placeholder="Enter pay">
      ...
      <div class="modal-body">
            <form action="" id="add-user-form" method="post">
              ...
              <div class="form-group row" id="cp_row">
                ...
                <div class="col-sm-10">
                  <select class="form-control inputs_with_bottom_border select2" id="collection_point_id" name="collection_point_id">
                    <!-- <option value="">Select here</option> -->
              ...
              <div class="form-group row" id="airline_row">
                ...
                <div class="col-sm-10">
                  <select class="form-control inputs_with_bottom_border select2" id="airline_id" name="airline_id">
                    <!-- <option value="">Select here</option> -->
                    @if(!empty($airlines))
              ...
              <div class="form-group row" id="tests_row">
                ...
                <div class="col-sm-10">
                  <select class="form-control inputs_with_bottom_border select2" id="test_id" name="test_id">
                    <!-- <option value="">Select here</option> -->
                    @if(!empty($tests))
              ...
              <div class="form-group row" id="domain_row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control inputs_with_bottom_border" id="ae_domain" value="realtimepcr.pk" readonly="">
                </div>
              </div>
              <div class="form-group row">
                <label for="cp_name" class="col-sm-2 col-form-label pformlabel">Full Name:</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control inputs_with_bottom_border" id="cp_name" name="name" placeholder="Enter name">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control inputs_with_bottom_border" id="cp_contact_no" name="contact_no" placeholder="Enter contact no">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control inputs_with_bottom_border" id="cp_username" name="username" placeholder="Enter username">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control inputs_with_bottom_border" id="cp_password" name="password" placeholder="Enter password">
