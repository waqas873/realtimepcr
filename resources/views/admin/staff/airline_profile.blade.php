      ...
      <div class="card-body">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane p-3" id="Trx" role="tabpanel">
            ...
            <br>
            <div class="row">
              <table class="table table-borderless" id="airlineSystemInvoices">
                  <thead class="thead-dark">
                    <tr>
                      <th>Date</th>
                      <th>Invoice ID</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" name="airline_user_id" value="{{$result->id}}" class="airline_user_id">
