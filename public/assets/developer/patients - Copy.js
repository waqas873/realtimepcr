  ...
  $.ajax({
      ...
      success: function (data) {
        if(data.response){
          ...
          formData.append('reporting_hrs',$('#reporting_hrs').val());
          formData.append('tests[]',$('#tests').val());
          formData.append('test_profiles[]',$('#test_profiles').val());

          formData.append('passport_no',$('#passport_no').val());
          formData.append('airline',$('#airline').val());
          formData.append('country_id',$('#country_id').val());
          formData.append('flight_no',$('#flight_no').val());
          formData.append('flight_date',$('#flight_date').val());
          formData.append('flight_time',$('#flight_time').val());
          formData.append('booking_ref_no',$('#booking_ref_no').val());
          formData.append('ticket_no',$('#ticket_no').val());
