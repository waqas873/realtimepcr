        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group row">
                    <label for="lab_id" class="col-sm-4 col-form-label pformlabel no_padd">Filter By Labs:</label>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-4">
                <div class="form-group row">
                    <label for="test_id" class="col-sm-4 col-form-label pformlabel no_padd">Filter By Test:</label>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control inputs_with_bottom_border select2" id="doctor_id" name="doctor_id">
                          <option value="">Select Here</option>
                          <option value="all">All</option>
                          <?php
...
<div class="row align-items-center">
    <div class="col-sm-12" style="padding-top: 17px;">
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group row">
                    <label for="user_id" class="col-sm-4 col-form-label pformlabel no_padd">Filter By User:</label>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-4">
                <div class="form-group row">
                    <label for="payment_filter" class="col-sm-4 col-form-label pformlabel no_padd">Filter By Payment:</label>
                    <div class="col-sm-8">
                      <select class="form-control inputs_with_bottom_border select2" id="payment_filter" name="payment_filter">
                          <option value="">Select Here</option>
                          <option value="all">All</option>
            ...
            <div class="col-sm-4">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control inputs_with_bottom_border select2" id="lab_user" name="lab_user">
                          <option value="">Select Here</option>
                          <option value="all">All</option>
                          <?php
...
<div class="row align-items-center">
    <div class="col-sm-12" style="padding-top: 17px;">
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group row">
                    <label for="collection_point_id" class="col-sm-4 col-form-label pformlabel no_padd">Filter By Collection Point:</label>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-4">
                <div class="form-group row">
                    <label for="local_overseas" class="col-sm-4 col-form-label pformlabel no_padd">Local/Overseas Patients:</label>
                    <div class="col-sm-8">
                      <select class="form-control inputs_with_bottom_border select2" id="local_overseas" name="local_overseas">
                          <option value="">Select Here</option>
                          <option value="all">All</option>
