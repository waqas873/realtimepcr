...
<title>Embassy | Realtime PCR</title>
...
<li>
<a href="{{url('embassy/reports')}}" class="waves-effect">
<img src="{{asset('assets/icons/sidebar-icons/icon4.svg')}}" class="sidebar_icons">
<span> Patients List </span>
</a>
</li>
<li>
<a href="{{url('embassy/all-reports')}}" class="waves-effect">
<img src="{{asset('assets/icons/sidebar-icons/icon4.svg')}}" class="sidebar_icons">
...
<!-- Added by Raheel -->
<li>
<a href="{{url('embassy/labreports')}}" class="waves-effect">
<img src="{{asset('assets/icons/sidebar-icons/icon4.svg')}}" class="sidebar_icons">
<span>Labs Report</span>
</a>
</li>

<!--Raheel addition End here-->
...
<span class="d-none d-md-inline-block ml-1">Embassy<i class="mdi mdi-chevron-down"></i> </span>
</a>
