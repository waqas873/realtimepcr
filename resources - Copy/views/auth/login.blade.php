    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card" style="margin-top: 50%;">
                ...
                <div class="card-body">
                    <img src="https://pcr.realtimepcr.pk/assets/images/pcr-logo.png" height="170" alt="logo" class="loginpage-logo" style="
    display: block;
...
">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary login_btn" style="width: 100% !important;">
                                    {{ __('Login') }}
                                </button>
